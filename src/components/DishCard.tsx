...
const DishCard: React.FC<DishProps> = ({
  ...
  return <div className="flex border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow h-full">
      {/* Dish Image */}
      <div className="OIIII\n">
      ...
      <div className="flex-1 p-3 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex items-center">
            ...
            <button onClick={handleIncrement} className="h-8 w-8 rounded-full bg-[#7b1c2d] text-white flex items-center justify-center" aria-label="Aumentar quantidade">
