...
const DishCard: React.FC<DishProps> = ({
  ...
  return (
    <div className="flex border border-gray-200 rounded-lg overflow-hidden bg-white shadow-lg hover:shadow-xl transition-shadow h-full cursor-pointer" onClick={handleCardClick}>
      {/* Dish Image - Increased size and made it fill more space */}
      ...
      <div className="flex-1 p-4 flex flex-col justify-between">
        <div>
          <h3 className="font-medium text-gray-900 mb-2 text-lg">{name}</h3>
