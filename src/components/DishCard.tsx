...
const DishCard: React.FC<DishProps> = ({
  ...
  return <div className="flex border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow h-full cursor-pointer" onClick={handleCardClick}>
      ...
      {/* Dish Info */}
      <div className="flex-1 p-3 flex flex-col justify-between px-[88px]">
        <div>
