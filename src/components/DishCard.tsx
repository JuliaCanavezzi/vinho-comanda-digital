...
const DishCard: React.FC<DishProps> = ({
  ...
  return (
    <div className="flex border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow h-full">
      {/* Dish Image */}
          ...
          <div className="flex items-center">
            <button
              ...
              className={`h-8 w-8 rounded-full flex items-center justify-center ${
                quantity > 0 ? 'bg-[#7b1c2d] text-white' : 'bg-gray-200 text-gray-400'
              }`}
              disabled={quantity === 0}
